...
# ╔═╡ 7222a362-5169-4b23-a684-48b8ff53262f
md"""
- Time series:
  - Heart beat
  - 
- Video:
  - Dance moves or different body movement
  - Detecting fruits in garden using drone
- Images:
...
# ╔═╡ e3de546c-dd2b-45e6-9c03-c33bc8cffe0a
julia_filename = download("https://www.freecodecamp.org/news/content/images/2023/01/Ifihan-article-cover.png")

# ╔═╡ 92ac25f7-0b74-46bc-a604-30eb91c99565
julia = load(julia_filename)

# ╔═╡ 18d0ba58-c734-4379-a3ae-e1b321ced6f7
tannu = load("/Users/tannu/Downloads/WhatsApp Image 2023-03-31 at 10.45.42 AM.jpeg")
...
# ╔═╡ 90259979-cd65-4ec8-8f58-999ee109bb13
save("nose.png", nose)
...
function invert(color::AbstractRGB)
	new_color = RGB(1-red(color), 1-green(color), 1-blue(color))
	return new_color
end
...
# ╔═╡ bfb0b618-aaea-463e-91b5-dda1608fcdfe
@bind r Slider(0:0.05:1, show_value=true)

# ╔═╡ 40e14439-85b2-419d-b75f-3dcaf37f2908
@bind g Slider(0:0.05:1, show_value=true)

# ╔═╡ 79790632-8820-43ca-8f99-432ced8a560d
@bind b Slider(0:0.05:1, show_value=true)

# ╔═╡ 6f3018ce-a099-4bdc-b1ed-520514303c94
RGB(r,g,b)
...
# ╔═╡ ba0d7236-323c-4e05-9daf-60962debea70
@bind red_numbers Slider(1:100, show_value=true)

# ╔═╡ 490c6c42-21e8-47c3-a7b4-c090808de74f
@bind green_numbers Slider(1:100, show_value=true)

# ╔═╡ 69c97ed1-a626-4531-a3cf-12db060ac1c1
[RGB(red_val/red_numbers, green_val/green_numbers, 0) for red_val in 0:red_numbers, green_val in 0:green_numbers]

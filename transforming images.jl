...
# ╔═╡ 6b26dcce-b9bd-404d-b67d-f4bad5fbc0fc
md"""
...
# ╔═╡ ec0d63ef-59df-49c8-aa34-d0f4b8bb2697
md"""
---
"""

# ╔═╡ edfb8684-7b6e-4e47-8a6c-84e565d27a30
y = 1u"km"

# ╔═╡ 48b1c5ad-4a96-43e2-93cc-c5175e988656
x = [1.0, 2.0]u"km"

# ╔═╡ 5795b57a-1954-4425-938e-cbbd9558e19a
a = [1, 2, 3]

# ╔═╡ ce8d15af-4356-4585-af53-6bd70ee951b4
au1 = eval(2a)u"m"

# ╔═╡ 8d9f3343-2a77-49e9-933b-494bf0f59cca
au2 = 3a*@u_str("cm")

# ╔═╡ dd2b2efd-9643-427f-9056-e39b36499701
au3 = 2u"mm".*3a

# ╔═╡ ca3d1b81-a929-4e23-87da-0af199826d9a
b = 1u"μm"   

# ╔═╡ 587d504a-a11a-4ff1-a70c-dc4ba9d55fa2
au4 = a.*oneunit(b)

# ╔═╡ cfdb6577-ac2d-40aa-b2e3-fe80a57e85a1
c = 10

# ╔═╡ 2deaae55-07a0-4e21-80ff-8ea992efdcc0
cu1 = eval(2c)u"m"
...
# ╔═╡ b069e245-098e-48e9-b2d1-6a704854029b
md"""
**Kronecker product**

A is an m x n matrix. B is an p x q matrix. A ⊗ B is mp x nq matrix. A ⊗ B contains all the possible products of the entries of the two matrices.
...
# ╔═╡ cd274535-7219-44ee-996d-09cc3cde18ab
nose = load("/Users/tannu/Explore/Julia course/nose.png")

# ╔═╡ c5a992a0-01b7-4756-b2e7-f18e661c9a36
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "cdf31234f47b8cf9eee1accc253b047d66c0a519"
